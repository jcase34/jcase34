...
### iOS Project Demos
#### Classic Hangman (Logic + UI built in Swift)
...
#### iTunes Store Search
Built this app out of tutorials to gain understanding of URLSession, querying database for text/images, etc. 
...
See [this link](https://github.com/jcase34/TrashMapper-iOS-Project) for more details on this project I'm currently working on.
